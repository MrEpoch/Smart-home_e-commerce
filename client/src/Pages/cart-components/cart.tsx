    ...
    return (
        <>
            ...
            <Modal className="cart_modal" show={show} onHide={handle_close} role="dialog">
                ...
                <Modal.Footer>
                    <button onClick={handle_payment} className="btn btn-primary">Proceed to pay</button>
                    <button onClick={handle_close} className="btn btn-secondary">Continue shopping</button>
                </Modal.Footer>
            </Modal>
        </>
    )
